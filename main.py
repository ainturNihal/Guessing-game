...
time.sleep(2)
print("On this round you will get only one chance of guessing")
time.sleep(3)
print("And I will guess from 0-10000")
time.sleep(2)
print("Winning this round is like next to million")
print("Nerves?")
time.sleep(1)
print("oh,don't be")
time.sleep(1)
print("But you should be")
time.sleep(1)
print("Okay timeto guess!")
print("Guess a number from 0-10,000")
time.sleep(1)
print("Remember only one choice!")
time.sleep(1)
